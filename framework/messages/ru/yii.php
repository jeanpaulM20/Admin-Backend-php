...
return array (
  ...
  'CSecurityManager requires PHP OpenSSL extension to be loaded in order to use data encryption feature.' => 'Для использования возможности шифрования данных компоненту CSecurityManager требуется PHP-расширение OpenSSL.',
  ...
  'Failed to initialize the OpenSSL cipher method.' => 'Не удалось инициализировать метод шифрования OpenSSL.',
