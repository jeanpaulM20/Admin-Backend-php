...
function buildPrompt(exercise: Exercise): string {
  ...
  return `Moody, authentic outdoor fitness documentary photography. ${athlete} with a fit, natural-looking physique is ${exerciseDesc}. The athlete is completely barefoot, NO shoes, NO socks. CRITICAL ANATOMY: each foot has exactly 5 toes, each hand has exactly 5 fingers. The bare feet show natural toe splay with all five toes clearly visible and anatomically correct, natural arch engagement, grounding firmly into the surface. The scene is shot outdoors ${ground} The background features a misty, atmospheric outdoor training environment with mountains or trees fading into soft fog, shallow depth of field. The athlete is wearing a simple matte black sleeveless performance shirt and matching matte black training shorts. The lighting is overcast, diffused natural daylight — soft and even with no harsh shadows, like a cloudy alpine morning. The overall mood is raw, focused and documentary, like a candid behind-the-scenes moment during an outdoor training camp. Shot on an 85mm prime lens, cool desaturated color grading with blue-grey tones, subtle film grain, sharp focus on the athlete, 8k resolution, editorial magazine quality.`;
}
