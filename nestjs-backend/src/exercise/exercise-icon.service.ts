...
function buildPrompt(exercise: Exercise): string {
  ...
  return `Natural, authentic outdoor fitness photography with a warm, candid documentary feel. ${athlete} with a fit, natural-looking physique is ${exerciseDesc}. The athlete is completely barefoot, with absolutely NO shoes and NO socks. The bare feet show natural toe splay and arch engagement, grounding firmly into the surface. The scene is shot outdoors ${ground} The background is a real outdoor training environment with soft natural bokeh. The athlete is wearing a simple matte black sleeveless shirt and matching matte black training shorts. The lighting is soft, warm natural daylight — golden hour or open shade — creating gentle, flattering shadows on the skin. The overall mood is calm, focused and real, like a candid moment during an outdoor training session. Shot on an 85mm lens, natural warm color tones, sharp focus on the athlete, 8k resolution, authentic and approachable.`;
}
