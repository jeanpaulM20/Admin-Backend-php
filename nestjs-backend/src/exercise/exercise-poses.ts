...
export const EXERCISE_POSES: Record<number, string> = {
  ...
  17: 'frontal full body view of person standing balanced on ONE leg on a visible blue/grey balance cushion/wobble pad. The standing leg is straight (slight 10 degree bend), the other leg is lifted with the knee bent at 90 degrees forward and the foot hovering at standing-knee height. Both arms hang straight down at the sides, relaxed, NOT on hips, NOT lifted. Body upright, head facing forward, calm focused expression.',
  209: 'frontal full body view of person performing a basic single-leg stand on solid ground. The standing leg is fully straight (knee locked, hip extended), bare foot flat on the ground. The other leg is lifted with the knee bent forward at 90 degrees, foot hovering naturally at standing-knee height. Both arms hang straight down at the sides, fully relaxed and extended, hands NOT on hips, NOT lifted, NOT crossed — simply hanging naturally beside the body. Body perfectly upright and vertical, shoulders relaxed, head facing straight forward, calm focused expression.',
