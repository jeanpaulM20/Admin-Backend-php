...
export const EXERCISE_POSES: Record<number, string> = {
  ...
  22: 'side profile view of a person performing single-leg calf raise at peak top position — standing on ONE leg balanced HIGH UP on the ball of the foot and toes only, heel lifted maximally off the ground (3-4 inches), calf muscle strongly contracted and visible. The other leg is lifted off the ground beside the standing leg, knee slightly bent. Body upright, arms relaxed at sides, looking forward. Clear side angle showing the lifted heel and the strongly defined calf.',
