...
export const EXERCISE_POSES: Record<number, string> = {
  ...
  22: 'CLOSE-UP side view of bare feet on a thick black rubber aerobic step box (15-20cm tall, clearly elevated above the ground). One bare foot is on top of the step with only the ball of the foot/toes on the step surface. The heel of that foot is hanging off the back edge of the step and is dropped DOWN well below the top of the step (in deep calf stretch / eccentric position). The other foot is lifted up beside the standing leg, not touching anything. Camera angle: side profile showing the clear height difference between the lifted step platform and the ground below. The step box, the lowered heel, and the gap underneath the heel must all be prominently visible.',
