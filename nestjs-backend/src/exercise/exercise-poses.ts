...
export const EXERCISE_POSES: Record<number, string> = {
  ...
  17: 'WIDE LANDSCAPE frontal view of a person balancing on one bare foot on a visible blue balance pad/cushion, framed to include the fully outstretched arms reaching the left and right edges of the image. Both arms are HORIZONTAL and FULLY EXTENDED outward at exact shoulder height like a crucifix or yoga warrior 2 — fingertips pointing far to the left and far to the right of the frame. The other leg is bent at the knee, lower leg pointing backward, foot raised toward the buttocks. Standing leg straight, body upright, eyes closed, focused balance pose. Frame must be wide enough to show both fingertips.',
  209: 'WIDE LANDSCAPE frontal view of a person balancing on one bare foot on solid grass, framed to include the fully outstretched arms reaching the left and right edges of the image. Both arms are HORIZONTAL and FULLY EXTENDED outward at exact shoulder height like a crucifix or yoga warrior 2 — fingertips pointing far to the left and far to the right of the frame. The other leg is bent at the knee, lower leg pointing backward, foot raised toward the buttocks. Standing leg straight, body upright, head facing forward. Frame must be wide enough to show both fingertips fully in shot.',
