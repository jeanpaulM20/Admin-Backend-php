...
export const EXERCISE_POSES: Record<number, string> = {
  ...
  17: 'frontal full body view of person standing balanced on ONE leg on a visible blue/grey balance cushion/wobble pad. The standing leg is straight (slight 10 degree bend), the other leg is lifted with the knee bent at 90 degrees forward and the foot hovering at standing-knee height. Both hands are placed firmly on the hips (akimbo position). Body upright, head facing forward, calm focused expression.',
  209: 'frontal full body view of person performing a basic single-leg stand on solid ground. The standing leg is fully straight (knee locked, hip extended), bare foot flat on the ground. The other leg is lifted with the knee bent forward at 90 degrees, foot hovering naturally at standing-knee height. Both hands are placed firmly on the hips (akimbo position, fingers facing forward, elbows out to sides). Body perfectly upright and vertical, shoulders relaxed, head facing straight forward, calm focused expression. Clean simple balanced stance.',
