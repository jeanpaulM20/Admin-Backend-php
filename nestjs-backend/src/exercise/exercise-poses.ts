...
export const EXERCISE_POSES: Record<number, string> = {
  ...
  17: 'frontal full body view of person standing balanced on ONE leg on a visible blue/grey balance cushion/wobble pad. The standing leg is straight, the other leg is lifted behind with the knee bent at 90 degrees, foot raised up toward the glutes. CRITICAL ARM POSITION: both arms are extended OUT TO THE SIDES horizontally at shoulder height (T-shape / airplane arms), palms facing down, elbows straight. NOT on hips, NOT hanging down — arms stretched wide for balance. Body upright, head facing forward, calm focused expression.',
  209: 'frontal full body view of person performing a basic single-leg stand on solid ground. The standing leg is fully straight (knee locked, hip extended), bare foot flat on the ground. The other leg is lifted behind with the knee bent at 90 degrees, foot raised toward the glutes. CRITICAL ARM POSITION: both arms are extended straight OUT TO THE SIDES horizontally at shoulder height (T-shape / airplane arms / cross position), palms facing down, elbows fully straight, fingers extended. NOT on hips, NOT hanging down at sides — arms stretched WIDE like an airplane for balance. Body perfectly upright and vertical, shoulders relaxed, head facing straight forward.',
  ...
  22: 'STRICT SIDE PROFILE close-up of feet area showing person standing on TIPTOES (en pointe). The standing foot is on the BALL/TOES only — the heel is lifted HIGH (at least 10 cm / 4 inches) above the ground in a maximally plantar-flexed position. The ankle is in extreme plantar flexion forming roughly a 130-140 degree angle. The lifted heel and the air gap underneath it must be clearly visible from the side. The standing leg knee is locked perfectly straight (NOT bent). The other foot is lifted off the ground next to the standing ankle. Body fully upright and vertical from head to grounded toes, no hip hinge, no knee bend. Visible calf muscle contraction. Frame: from waist down to feet, side angle, no obstructions hiding the lifted heel.',
