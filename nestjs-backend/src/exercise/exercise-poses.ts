...
export const EXERCISE_POSES: Record<number, string> = {
  ...
  22: 'side profile view of a person performing a single-leg calf raise at the top position. CRITICAL BODY ALIGNMENT: the standing leg knee is FULLY LOCKED STRAIGHT (0 degree bend), the hip is FULLY EXTENDED (no hinge, no forward lean), the entire body forms one perfectly straight vertical line from head through shoulders, hips, knee, down to the toes — only the ankle joint is moving. The person is balanced on the TOES/BALLS of one foot with the heel of that foot lifted maximally UP off the ground (4 inches high), calf muscle visibly contracted. The other foot hangs loose beside the standing leg, NOT bent at the hip or knee, just relaxed. Arms relaxed straight down at sides. Side profile camera angle clearly showing the lifted heel, the straight standing leg, and the upright vertical posture.',
