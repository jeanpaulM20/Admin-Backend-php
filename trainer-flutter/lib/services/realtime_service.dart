...
/// with each event type ('chat', 'plan_updated', …). Replaces the old (dead)
/// Firebase RTDB EventSource. Auto-reconnects.
class RealtimeService {
  ...
  void connect() {
    ...
    try {
      ...
      final url =
          '${ApiConfig.baseUrl}events/stream?channel=$channel&token=${Uri.encodeComponent(token)}';
