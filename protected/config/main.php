	...
	'components'=>array(
		...
		'urlManager'=>array(
			...
			'rules'=>array(
				...
				array('api/clientStart',      'pattern'=>'api/client/start/<clientId:\d+>',                         'verb'=>'GET'),
				array('api/clientCalendar',   'pattern'=>'api/client/calendar/<clientId:\d+>',                      'verb'=>'GET'),
				array('api/clientProfile',    'pattern'=>'api/client/profile/<clientId:\d+>',                       'verb'=>'GET'),
				array('api/clientCredits',    'pattern'=>'api/client/credits/<clientId:\d+>',                       'verb'=>'GET'),
				array('api/clientCreditsBuy', 'pattern'=>'api/client/credits/buy/<clientId:\d+>/<creditId:\d+>', 'verb'=>'GET'),
				array('api/clientInvoices',   'pattern'=>'api/client/invoices/<clientId:\d+>',                      'verb'=>'GET'),
				array('api/clientTests',      'pattern'=>'api/client/tests/<clientId:\d+>',                         'verb'=>'GET'),
				array('api/clientCancelAppt', 'pattern'=>'api/client/appointment/<clientId:\d+>/<appointmentId:\d+>','verb'=>'DELETE'),
				array('api/clientBooking',    'pattern'=>'api/client/appointment/<clientId:\d+>',                   'verb'=>'POST'),
				array('api/clientUpdateAppt', 'pattern'=>'api/client/appointment/<appointmentId:\d+>',              'verb'=>'PUT'),
