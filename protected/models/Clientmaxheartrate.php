 ...
 */
class Clientmaxheartrate extends ActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('id, max_heart_rate, date, date_range, sort, client_id, client_search', 'safe'),
			array('id, max_heart_rate, date, date_range, sort, client_id, client_search', 'safe', 'on' => 'search'),
		);
	}
	...
	public function getModelDescription()
	{
		...
		$obj->title = 'Client max heart rates';
		return $obj;
	}

	public function getModelDisplay()
	{
		return "$this->date: $this->max_heart_rate";
	}
