...
class AbbonementController extends Controller {
	...
	public function actionAdmin() {
		...
		$model = new Abbonement('search');
		$model->unsetAttributes();  // clear any default values
		if (isset($_GET['Abbonement']))
			$model->attributes = $_GET['Abbonement'];
	...
	public function loadModel($id) {
		$model = Abbonement::model()->findByPk($id);
		if ($model === null)
	...
	protected function performAjaxValidation($model) {
		if (isset($_POST['ajax']) && $_POST['ajax'] === 'abbonement-form') {
