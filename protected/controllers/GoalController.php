...
class GoalController extends Controller
{
	...
	{
		echo CJSON::encode(Goal::getDropdownListByClientId($id));
	}
	...
	public function gridAchievedColumn($data, $row)
	{
		if ($data->achieved) {
			return 'x';
		} else {
	...
	{
		Yii::app()->request->sendFile('Goal.csv', Yii::app()->user->getState('export'));
