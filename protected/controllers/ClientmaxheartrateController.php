...
class ClientmaxheartrateController extends Controller
{
	...
	public function actionCreate()
	{
		...
		$model	 = new Clientmaxheartrate;
		$oldData = array();

		// Uncomment the following line if AJAX validation is needed
		// $this->performAjaxValidation(ch.esgroup.domainconverter.DomainModel@138d56e);

		if (isset($_POST['Clientmaxheartrate'])) {
			$model->attributes = $_POST['Clientmaxheartrate'];
			if ($model->save()) {
	...
	{
		$model = Clientmaxheartrate::model()->findByPk($id);
		if ($model === null)
	...
	{
		return Clientmaxheartrate::model();
	}
