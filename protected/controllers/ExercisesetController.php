...
class ExercisesetController extends Controller
{
	...
	public function actionCreate()
	{
		...
		// $this->performAjaxValidation(ch.esgroup.domainconverter.DomainModel@54570a);

		if (isset($_POST['Exerciseset'])) {
			$model->attributes = $_POST['Exerciseset'];
	...
	public function actionUpdate($id)
	{
		...
		if (isset($_POST['Exerciseset'])) {
			$model->attributes = $_POST['Exerciseset'];
			if (!isset($_POST['Exerciseset']['exercises'])) {
				$model->exercises = array();
			}
			if (!isset($_POST['Exerciseset']['trainings'])) {
				$model->trainings = array();
			}
	...
	public function actionAdmin()
	{
		...
		$model				 = new Exerciseset('search');
		$model->unsetAttributes();  // clear any default values
		if (isset($_GET['Exerciseset']))
			$model->attributes	 = $_GET['Exerciseset'];
	...
	{
		$model = Exerciseset::model()->findByPk($id);
		if ($model === null)
	...
	{
		if (isset($_POST['ajax']) && $_POST['ajax'] === 'exerciseset-form') {
	...
	{
		Yii::app()->request->sendFile('Exerciseset.csv', Yii::app()->user->getState('export'));
