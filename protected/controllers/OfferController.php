...
class OfferController extends Controller
{
	...
	public function actionCreate()
	{
		...
		// $this->performAjaxValidation(ch.esgroup.domainconverter.DomainModel@1d183b7);
	...
	public function actionUpdate($id)
	{
		...
		{
			$model->attributes=$_POST['Offer'];
			if (!isset($_POST['Offer']['locations'])) {
...
'filter' => $this->getModel()->getTypeValues(),
	...
	{
		Yii::app()->request->sendFile('Offer.csv',Yii::app()->user->getState('export'));
