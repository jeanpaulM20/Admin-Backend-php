...
class PerformanceController extends Controller
{
	...
	public function actionCreate()
	{
		...
		// $this->performAjaxValidation(ch.esgroup.domainconverter.DomainModel@2c7ac5);

		if (isset($_POST['PerformanceTest'])) {
			$data = $_POST['PerformanceTest'];
	...
	public function actionAdmin()
	{
		...
		$model				 = new PerformanceTest('search');
		$model->unsetAttributes();  // clear any default values
		if (isset($_GET['PerformanceTest']))
			$model->attributes	 = $_GET['PerformanceTest'];
	...
	{
		$model = PerformanceTest::model()->findByPk($id);
		if ($model === null)
	...
	{
		if (isset($_POST['ajax']) && $_POST['ajax'] === 'metric-form') {
	...
	{
		Yii::app()->request->sendFile('PerformanceTest.csv', Yii::app()->user->getState('export'));
