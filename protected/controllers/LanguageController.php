...
class LanguageController extends Controller
{
	...
	public function actionCreate()
	{
		...
		// $this->performAjaxValidation(ch.esgroup.domainconverter.DomainModel@9ad840);
	...
	public function gridLanguageColumn($data, $row) {
	$valuesList = $this->getModel()->getLanguageValues();
	return $valuesList[$data->language];
}
...
'filter' => $this->getModel()->getLanguageValues(),
	...
	{
		Yii::app()->request->sendFile('Language.csv',Yii::app()->user->getState('export'));
