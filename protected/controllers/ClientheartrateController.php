...
class ClientheartrateController extends Controller
{
	...
	public function actionCreate()
	{
		...
		$model	 = new Clientheartrate;
		$oldData = array();

		// Uncomment the following line if AJAX validation is needed
		// $this->performAjaxValidation(ch.esgroup.domainconverter.DomainModel@138d56e);

		if (isset($_POST['Clientheartrate'])) {
			$model->attributes = $_POST['Clientheartrate'];
			if ($model->save()) {
	...
	{
		$model = Clientheartrate::model()->findByPk($id);
		if ($model === null)
