...
class ClientaccesstokenController extends Controller
{
	...
	public function actionCreate()
	{
		...
		if(isset($_POST['Clientaccesstoken']))
		{
			$model->attributes=$_POST['Clientaccesstoken'];
	...
	{
		$model=Clientaccesstoken::model()->findByPk($id);
		if($model===null)
